...
public class TopfragPersenterImpl implements MainContract.SubPresenter{
    MainContract.XSubView xSubview;
    private String url="http://api.cntv.cn/video/videolistById?\n" +
            "vsid=VSET100284428835&n=7&serviceId=panda&o=desc&of=time&p=";
    public TopfragPersenterImpl(MainContract.XSubView xSubview) {
