 ...
 */
public class Top_fragment extends BaseFragment implements MainContract.XSubView {
      TopfragPersenterImpl topfragPersenter=new TopfragPersenterImpl(this);
    ...
    protected int getLayout() {
        return R.layout.fragment_top_fragment;
    }
