 ...
 */
public class MountEmei_fragment extends BaseFragment implements MainContract.SubView {
    ...
    protected void initView(View view) {
        ...
        SubPresenterimpl_EMei subPresenterimpl_mountTai = new SubPresenterimpl_EMei(this);
