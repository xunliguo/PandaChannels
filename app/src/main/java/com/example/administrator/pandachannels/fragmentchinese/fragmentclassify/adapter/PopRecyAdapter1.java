...
public class PopRecyAdapter1 extends RecyclerView.Adapter<PopRecyAdapter1.ViewHolder> {
    ...
    @Override
    public PopRecyAdapter1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PopRecyAdapter1.ViewHolder holder, final int position) {
