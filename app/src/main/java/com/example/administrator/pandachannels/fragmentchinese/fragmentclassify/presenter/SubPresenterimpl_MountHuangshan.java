 ...
 */
public class SubPresenterimpl_MountHuangshan implements MainContract.SubPresenter {
    MainContract.SubView subview;
    ArrayList<BeanTaishan.LiveBean> list=new ArrayList<>();

    public SubPresenterimpl_MountHuangshan(MainContract.SubView subview) {
    ...
    public void requsetData() {
        subview.showLoading();
        OkHttpUtils.getInstance().getNetData(Url.HUANGSHAN, new OkHttpUtils.CallBacks() {
            @Override
